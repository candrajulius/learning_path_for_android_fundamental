...
import com.candra.mysharedprefences.FormUserPreferenceActivity.Companion.EXTRA_RESULT
import com.candra.mysharedprefences.FormUserPreferenceActivity.Companion.RESULT_CODE
import com.candra.mysharedprefences.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(),View.OnClickListener {
    ...
    private val resultLauncher = registerForActivityResult(
        ...
        if (result.data != null && result.resultCode == RESULT_CODE) {
            userModel = result.data?.getParcelableExtra<UserModel>(EXTRA_RESULT) as UserModel

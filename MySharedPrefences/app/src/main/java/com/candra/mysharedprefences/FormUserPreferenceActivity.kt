...
import com.candra.mysharedprefences.databinding.ActivityFormUserPreferenceActivityBinding

class FormUserPreferenceActivity : AppCompatActivity(), View.OnClickListener{

    private lateinit var binding: ActivityFormUserPreferenceActivityBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityFormUserPreferenceActivityBinding.inflate(layoutInflater)
